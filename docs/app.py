...
RECAPTCHA_SITE_KEY = '6LejebElAAAAABthZcecjz4apobkba-l0_1OXP4h'
...
def contrast():
    ...
    payload = {
        'secret': '6LejebElAAAAAKc8IVeumbY0CU1lIlpUvlO_jFc4',  # Replace this with your actual reCAPTCHA secret key
