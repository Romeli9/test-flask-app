...
RECAPTCHA_SITE_KEY = '6LcydbElAAAAABj6Z2q_sd7sRZlWDKDiCmGVXKE9'
...
def contrast():
    ...
    payload = {
        'secret': '6LcydbElAAAAABZzutS9dp0UF-erVfmFYylH5iue',  # Replace this with your actual reCAPTCHA secret key
